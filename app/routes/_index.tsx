...
export default function Index() {
  return (
    <div className='min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 transition-colors duration-300'>
      ...
      <section className='px-4 pt-24 pb-20 mx-auto max-w-7xl sm:px-6 lg:px-8'>
        <div className='max-w-3xl mx-auto text-center space-y-8'>
          ...
          <p className='mx-auto max-w-2xl text-xl text-gray-500 dark:text-gray-300 transition-colors duration-300'>
            ...
            your reach with AI-optimized posts.
          </p>
          <div className='mt-8'>
      ...
      {/* Final CTA Section (Reinserido) */}
      <section className='py-16 bg-gray-50 dark:bg-gray-900 transition-colors duration-300'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          <h2 className='text-3xl font-extrabold text-gray-900 dark:text-white mb-8 transition-colors duration-300'>
            Ready to create impactful content?
          </h2>
          <CTAButton to='/generate'>Start For Free</CTAButton>
        </div>
      </section>
    </div>
  );
